...
function toggleState() {
    if (focus.value) {
        ...
        placeholder.value = (props.placeholder as string) || props.placeholder;
    } else {
        container.value?.classList.remove('inputedit-active');
        if (!hasContent.value) {
            container.value?.classList.remove('inputedit-focus');
            placeholder.value = '';
        } else container.value?.classList.add('inputedit-focus');
    }
}
